-- intra-year attrition prediction training
...
enrolled AS (
    ...
    and date_key = (GETDATE()-365)::DATE::VARCHAR
    and (last_sa_day is null or last_sa_day > (GETDATE()-365)::DATE::VARCHAR)
),
...
fdss AS (
    SELECT date_key,
        ...
        frpl_status,
        CASE
	        WHEN enrolled.scholar_grade = '0' THEN CAST('8-15-2022' AS datetime)
	        WHEN enrolled.scholar_grade = '1' THEN CAST('8-17-2022' AS datetime)
	        WHEN enrolled.scholar_grade = '2' THEN CAST('8-17-2022' AS datetime)
	        WHEN enrolled.scholar_grade = '3' THEN CAST('8-15-2022' AS datetime)
	        WHEN enrolled.scholar_grade = '4' THEN CAST('8-15-2022' AS datetime)
	        WHEN enrolled.scholar_grade = '5' THEN CAST('8-15-2022' AS datetime)
	        WHEN enrolled.scholar_grade = '6' THEN CAST('8-17-2022' AS datetime)
	        WHEN enrolled.scholar_grade = '7' THEN CAST('8-17-2022' AS datetime)
	        WHEN enrolled.scholar_grade = '8' THEN CAST('8-15-2022' AS datetime)
	        WHEN enrolled.scholar_grade = '9' THEN CAST('8-8-2022' AS datetime)
	        WHEN enrolled.scholar_grade = '10' THEN CAST('8-8-2022' AS datetime)
	        WHEN enrolled.scholar_grade = '11' THEN CAST('8-8-2022' AS datetime)
	        WHEN enrolled.scholar_grade = '12' THEN CAST('8-8-2022' AS datetime)
	    END AS start_date,
	    CASE
	        WHEN enrolled.scholar_grade = '0' THEN CAST('6-16-2023' AS datetime)
	        WHEN enrolled.scholar_grade = '1' THEN CAST('6-16-2023' AS datetime)
	        WHEN enrolled.scholar_grade = '2' THEN CAST('6-16-2023' AS datetime)
	        WHEN enrolled.scholar_grade = '3' THEN CAST('6-16-2023' AS datetime)
	        WHEN enrolled.scholar_grade = '4' THEN CAST('6-16-2023' AS datetime)
	        WHEN enrolled.scholar_grade = '5' THEN CAST('6-16-2023' AS datetime)
	        WHEN enrolled.scholar_grade = '6' THEN CAST('6-16-2023' AS datetime)
	        WHEN enrolled.scholar_grade = '7' THEN CAST('6-16-2023' AS datetime)
	        WHEN enrolled.scholar_grade = '8' THEN CAST('6-16-2023' AS datetime)
	        WHEN enrolled.scholar_grade = '9' THEN CAST('6-7-2023' AS datetime)
	        WHEN enrolled.scholar_grade = '10' THEN CAST('6-7-2023' AS datetime)
	        WHEN enrolled.scholar_grade = '11' THEN CAST('6-7-2023' AS datetime)
	        WHEN enrolled.scholar_grade = '12' THEN CAST('6-7-2023' AS datetime)
	    END AS end_date,
        GETDATE()-365 AS run_date, -- should be GETDATE()-365 to get the date of the same time last year, otherwise replace with explicit dates for testing
        school_yr,
        attendance_status,
        excused
...
fs1 AS (
	...
	AND incident_dt <= GETDATE()-365
	AND incident_dt >= '8-8-2022'
	GROUP BY 1
),
